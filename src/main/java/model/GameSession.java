...
public class GameSession {
    ...
    public static void generateRandomMap(String code) throws IOException {
        String filePath = "H:\\Documents\\eclipse-workspace-eya\\Projet_v7\\src\\main\\webapp\\csv\\" + code + ".csv";
        String DefaultPath = "H:\\Documents\\eclipse-workspace-eya\\Projet_v7\\src\\main\\webapp\\csv\\default.csv";
